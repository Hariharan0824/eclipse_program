...
public class BrandsRunner {
	...
	//primitive data type to String
		...
		Short brand2=30;
		System.out.println("byte to String:"+brand2.toString());
		
		Integer brand3=30;
		System.out.println("byte t0 String:"+brand3.toString());
		
		Long brand4=15649877665l;
		System.out.println("byte to String:"+brand4.toString());
		
		Float brand5=30f;
		System.out.println("byte to String:"+brand5.toString());
		
		Double brand6=30d;
		System.out.println("byte to String:"+brand6.toString());
		
		Boolean brand7=false;
		System.out.println("byte to String:"+brand7.toString());
		
		Character brand8='a';
		System.out.println("byte to String:"+brand8.toString());

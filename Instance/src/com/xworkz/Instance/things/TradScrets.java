...
public class TradScrets extends AI{
	...
	public TradScrets(String name, int noOfPatents, int importenPatents, String typesName) {
		super();
		this.name = name;
	...
	public void display() {
		System.out.println("This is TradScrets method");
	}

...
public class Tradmarks extends AI{
	...
	public Tradmarks(String name, int noOfPatents, int importenPatents, String typesName) {
		super();
		this.name = name;
	...
	public void display() {
		System.out.println("This is Tradmarks method");
	}

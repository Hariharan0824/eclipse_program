...
public class TeaShop {
	 ...
	 public TeaShop(String shopName) {
		 System.out.println("This is 1 Argument Passing");
		 this.shopName=shopName;
		 }
public TeaShop(String shopName,String colour[]) {
	 ...
	 public TeaShop(String shopName,String typeOfShop) {
		 System.out.println("This is  2 Argument Passing");
		 this.shopName=shopName;
		 this.typeOfShop=typeOfShop;
		}
public TeaShop(String shopName,String typeOfShop,int customer) {
	 System.out.println("This is  3 Argument Passing");
	 this.shopName=shopName;
	 this.typeOfShop=typeOfShop;
	 this.customer=customer;
	}
public TeaShop(String shopName,String typeOfShop,int customer,String colour[]) {
...
public TeaShop(String colour[],String location[]) {
...
public TeaShop(String colour[],String location[],int price[]) {
 ...
 public TeaShop(String shopName,String typeOfShop,int price[],String location[],String colour[],int customer) {
